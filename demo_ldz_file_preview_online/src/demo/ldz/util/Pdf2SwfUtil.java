...
public class Pdf2SwfUtil {
    ...
    public static String pdf2swf(String fileString) throws Exception {
            ...
            if (pdfFile.exists()) {
                if (environment == 1)// windows环境处理
                {
                    try {
                        ...
                        Process p = r.exec("C:/Program Files (x86)/SWFTools/pdf2swf.exe " + pdfFile.getPath() + " -o " + swfFile.getPath()
