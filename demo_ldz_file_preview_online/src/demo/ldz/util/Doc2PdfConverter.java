...
public class Doc2PdfConverter {
    ...
    public Doc2PdfConverter(String fileString) {
        ini(fileString);
    }
            ...
            if (pdfFile.exists()) {
                if (environment == 1)// windows环境处理
                {
                    try {
                        ...
                        Process p = r.exec("C:/Program Files (x86)/SWFTools/pdf2swf.exe " + pdfFile.getPath() + " -o " + swfFile.getPath() + " -T 9 -t -s storeallcharacters");
    ...
    public static void main(String s[]) {
        Doc2PdfConverter d = new Doc2PdfConverter("E:/（报审稿）战略协议.pdf");
        d.conver();
    }
}